...
def TesteUndoRedo():
    ...
    lista1 = lista
    rezultat = adauga_rezervare(1,"Iustin", "Economy", 800, "Da", lista, undoOperations, redoOperations)
    ...
    lista = rezultat
    lista1 = lista
    rezultat = adauga_rezervare(2,"Iustin", "Economy", 800, "Da", lista, undoOperations, redoOperations)
    undoOperations.append(
    ...
    lista = rezultat
    lista1 = lista
    rezultat = adauga_rezervare(3,"Iustin", "Economy", 800, "Da", lista, undoOperations, redoOperations)
    undoOperations.append(
